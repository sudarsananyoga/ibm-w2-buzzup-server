...
import com.stackroute.buzzup.controller.TheatreController;
...
public class TheatreControllerTest {
    ...
    public void registerTheatreSuccess() throws Exception {
        ...
        assertNotNull("hi");
        mockMvc.perform(post("/api/v1/theatre")
...
/*    @Test
    public void updateTheatreFailure() throws Exception {
            theatre.setName("pvr");
            when(theatreService.updateTheatre(eq(theatre.getId()), any())).thenThrow(TheatreNotFoundException.class);
            mockMvc.perform(put("/api/v1/theatre/Jhon123")
                    .contentType(MediaType.APPLICATION_JSON).content(asJsonString(theatre)))
...
*/
    ...
    public void deleteTheatreSuccess() throws Exception {
        ...
        assertNotNull("hi");
        mockMvc.perform(delete("/api/v1/theatre/Jhon123")
   ...
   @Test
    public void deleteTheatreFailure() throws Exception {
        ...
        assertNotNull("hi");
        mockMvc.perform(delete("/api/v1/theatre/Jhonny123")
                .contentType(MediaType.APPLICATION_JSON)).andExpect(status().isNotFound())
                .andDo(print());
    }

/*    @Test
    public void getTheatreByemailIdSuccess() throws Exception {
        when(theatreService.getTheatreByemailId(theatre.getEmailId())).thenReturn(theatre);
        mockMvc.perform(get("/api/v1/theatre/Jhonny123@gmail.com")
