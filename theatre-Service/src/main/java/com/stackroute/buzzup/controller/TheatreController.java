...
import com.stackroute.buzzup.service.TheatreService;
/*
...
public class TheatreController {
    ...
    public ResponseEntity<?> register(@RequestBody Theatre theatre){
        try{        
        ...
        {
            return new ResponseEntity<String>("theatre Already Exists",HttpStatus.CONFLICT);
        }
        }
	 ...
	 *
	 * This handler method should map to the URL "/api/v1/theatre//{theaterId}" using HTTP Delete
	 * method" where "id" should be replaced by a valid Id without {}
	 */
     @DeleteMapping("/api/v1/theatre/{theaterId}")
     public ResponseEntity<?> deleteTheatre(@PathVariable() String theaterId) {
 	 ...
 	 * 
 	 * This handler method should map to the URL "/api/v1/theatre/{emailId}" using HTTP PUT method.
 	 */
    ...
    return responseEntity;
 	 ...
 	 * 
 	 * 
 	 * This handler method should map to the URL "/api/v1/theatre/{emailId}" using HTTP GET method
 	 */

	@GetMapping("/api/v1/theatre/{emailId}")
     public ResponseEntity<?> getTheatreByemailId(@PathVariable String emailId) {
         try {
